...
2. quasar-dev - this directory holds files for developing Quasar itself via Docker. (WIP - coming soon!!!)
3. container-dev - this directory holds the dockerfile, which will set up the container creating environment and is intended only for Quasar core team developers.
